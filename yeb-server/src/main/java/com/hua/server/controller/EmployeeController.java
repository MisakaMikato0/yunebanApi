...
public class EmployeeController {
    ...
    @GetMapping("/")
    public RespPageBean getAllEmployees(
    ...
    @DeleteMapping("/{id}")
    public RespBean removeEmp(@PathVariable("id") Integer id) {
    ...
    public RespBean ImportEmployee(MultipartFile file){
        ...
        try {
            ...
            employees.forEach(employee -> {
                ...
                //政治面貌id
                employee.setPoliticId(politicsStatuses.
                        get(politicsStatuses.indexOf(new PoliticsStatus(
